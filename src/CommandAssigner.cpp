...
// #endif
  ...
  QString battleCommands = "RING,JOINBATTLE,JOINEDBATTLE,UPDATEBATTLEINFO,LEFTBATTLE,BATTLEOPENED,BATTLECLOSED,CLIENTBATTLESTATUS,CLIENTSTATUS,SETSCRIPTTAGS,REQUESTBATTLESTATUS,ADDSTARTRECT";
