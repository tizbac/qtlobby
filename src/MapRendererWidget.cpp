...
MapRendererWidget::MapRendererWidget( QWidget* parent ) : QGLWidget( parent ) {
    ...
    if ( m_glslSupported ) {
        if ( m_waterShaderSet.loadShaders( P( "shaders/water.glsl" ) ) ) {
        ...
        if ( m_landShaderSet.loadShaders( P( "shaders/land.glsl" ) ) ) {
...
void MapRendererWidget::compileSimpleWaterPlane() {
    ...
    glTexCoord2f( 0, 0 );
    glVertex3f( -overkill*m_heightmap.getWidth(), 0, -overkill*m_heightmap.getHeight() );
    glTexCoord2f( 0, 1 );
    glVertex3f( -overkill*m_heightmap.getWidth(), 0, overkill*m_heightmap.getHeight() );
    glTexCoord2f( 1, 0 );
    glVertex3f( overkill*m_heightmap.getWidth(), 0, -overkill*m_heightmap.getHeight() );
